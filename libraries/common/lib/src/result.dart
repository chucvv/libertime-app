...
abstract class Result<T> with _$Result<T> {
  ...
  static Result<T> guard<T>(T Function() body) {
    try {
      ...
      return Result.failure(error: ErrorResolver(e));
    }
  }
  ...
  void ifFailure(Function(ErrorResolver e) body) {
    maybeWhen(
      failure: (e) => body(e),
      orElse: () {
        // no-op
...
extension ResultObjectExt<T> on T {
  ...
  Result<T> asFailure(Exception e) => Result.failure(error: ErrorResolver(e));
}
